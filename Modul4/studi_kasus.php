...
var jawab =confirm(\"Apakah anda yakin ingin menghapus data ini?\");
if(jawab){
document.location.href=\"index.php?m=data&act=del&id=".$id."&confirm=1\"; 
}else{
document.location.href=\"index.php\"; 
}
</script>";
